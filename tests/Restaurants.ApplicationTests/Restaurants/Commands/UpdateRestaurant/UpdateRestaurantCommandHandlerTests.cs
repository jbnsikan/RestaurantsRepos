...
public class UpdateRestaurantCommandHandlerTests
{
    ...
    public async Task Handle_WithValidRequest_ShouldUpdateRestaurants()
    {
        ...
        _restaurantAuthorizationServiceMock.Setup(m => m.Authorize(restaurant, RessourceOperation.Update))
            .Returns(true);
    ...
    public async Task Handle_WithUnauthorizedUser_ShouldThrowForbidException()
    {
        ...
        _restaurantAuthorizationServiceMock
            .Setup(a => a.Authorize(existingRestaurant, RessourceOperation.Update))
                .Returns(false);
